...
| `attackMac` | String | ✅ | @NotBlank | 被诱捕者MAC |
| `attackIp` | String | ✅ | @NotBlank | 被诱捕者IP |
| `threatScore` | Double | ❌ | ≥0 | 威胁评分 |
| `customerId` | String | ✅ | @NotBlank | 客户ID |
...
```json
{
  ...
  "resolution": null,
  "resolvedAt": null,
  "createdAt": "2025-10-16T02:30:00Z",
  "updatedAt": "2025-10-16T02:30:00Z"
}
```
...
```json
{
  ...
  "resolvedAt": null,
  "createdAt": "2025-10-16T02:30:00Z",
  "updatedAt": "2025-10-16T03:00:00Z"
}
```
...
```json
{
  "content": [
    ...
    },
    {
      ...
      "attackIp": "192.168.75.200",
      "threatScore": 8500.0,
      "customerId": "customer_a",
      "createdAt": "2025-10-16T01:15:00Z"
    }
  ],
  "pageable": {
    "pageNumber": 0,
...
```json
{
  ...
  "createdAlerts": [
    ...
    },
    {
      "id": 12346,
      "title": "HIGH: 批量告警2",
      "createdAt": "2025-10-16T02:30:01Z"
    }
  ],
  "errors": []
}
