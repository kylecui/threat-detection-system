...
-- 原始攻击事件存储表 (用于追溯和审计)
-- ============================================================================
-- ✅ 持久化表: 使用 CREATE IF NOT EXISTS 保护历史数据
...
-- 威胁告警历史表 (保存所有评分和告警)
-- ============================================================================
-- ✅ 持久化表: 使用 CREATE IF NOT EXISTS 保护历史告警数据
