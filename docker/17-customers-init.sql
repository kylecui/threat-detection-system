-- Customer Management Database Schema (Docker Initialization)
-- This script initializes the customers table for Docker deployments
...
-- Grant permissions
GRANT SELECT, INSERT, UPDATE, DELETE ON customers TO threat_user;
GRANT USAGE, SELECT ON SEQUENCE customers_id_seq TO threat_user;