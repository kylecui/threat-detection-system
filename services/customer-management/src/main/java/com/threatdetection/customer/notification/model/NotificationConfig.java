package com.threatdetection.customer.notification.model;
...
/**
 * 客户通知配置实体
 * 对应数据库表: customer_notification_configs
 */
@Entity
...
public class NotificationConfig {
    ...
    protected void onCreate() {
        ...
        if (webhookEnabled == null) webhookEnabled = false;
        if (enableRateLimiting == null) enableRateLimiting = true;
