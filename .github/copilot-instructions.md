...
**在执行任何操作之前（编写代码、测试脚本、修改配置、调整数据库等），必须先查阅 `docs/` 目录中的相关文档**

**文档导航三步法**：
1. **项目概况**：先阅读 `README.md` 了解整体架构
2. **定位文档**：通过 `docs/DOCUMENTATION_INDEX.md` 找到相关文档
3. **深入细节**：查阅具体子目录（`docs/api/`, `docs/design/`, `docs/testing/` 等）
...
- 日志格式：`docs/design/log_format_analysis.md`
- 测试方法：`docs/testing/`
